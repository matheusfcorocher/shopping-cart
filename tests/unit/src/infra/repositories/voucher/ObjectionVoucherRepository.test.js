...
const ObjectionVoucherRepository_1 = __importDefault(require("../../../../../../src/infra/repositories/voucher/ObjectionVoucherRepository"));
const VoucherModelFactory_1 = __importDefault(require("../../../../../support/factories/models/VoucherModelFactory"));
const { setupIntegrationTest } = require("../../../../../support/setup");
const voucherRepository = new ObjectionVoucherRepository_1.default();
    ...
    describe("#getAllVouchers", () => {
        describe("When method is called", () => {
            describe("result is a array instance of vouchers", () => {
                it("returns correct result", async () => {
                    ...
                    expect(vouchers[0]).toBeInstanceOf(entities_1.Voucher);
                });
            });
        ...
        describe("When service is unavailable", () => {
            it("returns error", async () => {
                ...
                await expect(() => voucherRepository.getAllVouchers()).rejects.toThrow(error);
            });
        });
    });
    describe("#getVoucherById", () => {
        describe("result is a voucher instance", () => {
            it("returns the correct result", async () => {
                const voucher = await voucherRepository.getVoucherById("7ea29c37-f9e7-4453-bc58-50ed4b5c0fcf");
                const expected = new entities_1.Voucher({
                    id: "7ea29c37-f9e7-4453-bc58-50ed4b5c0fcf",
                    code: "TEST1",
                    type: "percentual",
                    amount: 40,
        ...
        describe("When doesn't find a voucher by id", () => {
            it("returns error", async () => {
                ...
                await expect(() => voucherRepository.getVoucherById(id)).rejects.toThrow(notFoundError);
            });
        });
    });
    describe("#getVoucherByCode", () => {
        ...
        describe("When doesn't find a voucher by code", () => {
            it("returns error", async () => {
                ...
                await expect(() => voucherRepository.getVoucherByCode(code)).rejects.toThrow(notFoundError);
            });
        });
    });
    describe("#getNextId", () => {

import * as UseCase from "../../../../../src/application/Cart/GetCurrentCart";
...
describe("Application :: Cart :: GetCurrentCart", () => {
  describe("When cart doesn't have any line item", () => {
    describe("and cart doesnt have voucher", () => {
      it("returns correct cart", async () => {
        ...
        const getCurrentCart = UseCase.makeGetCurrentCart({ cartRepository });

        const result = await getCurrentCart("aaa");
  ...
  describe("When buyerId wasn't found", () => {
    it("returns not found error", async () => {
      ...
      expect(await getCurrentCart("bbb")).toEqual(

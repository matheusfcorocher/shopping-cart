import * as UseCase from "../../../../../src/application/Cart/RemoveVoucher";
...
describe("Application :: Cart :: RemoveVoucher", () => {
  describe("When cart doesn't have any line item", () => {
    describe("and cart doesnt have voucher", () => {
      it("returns correct cart", async () => {
        ...
        const removeVoucher = UseCase.makeRemoveVoucher({ cartRepository });

        const result = await removeVoucher("aaa");
  ...
  describe("When buyerId wasn't found", () => {
    it("returns not found error", async () => {
      ...
      expect(await removeVoucher("bbb")).toEqual(
  ...
  describe("When update the cart gives error", () => {
    it("returns error", async () => {
      ...
      await expect(() => removeVoucher("aaa")).rejects.toThrow(error);
    });
  });
});

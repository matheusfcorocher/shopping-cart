import * as UseCase from "../../../../../src/application/Cart/RemoveLineItem";
...
describe("Application :: Cart :: RemoveLineItem", () => {
  describe("When cart doesn't have any line item", () => {
    describe("and cart doesnt have voucher", () => {
      it("returns not found error", async () => {
        ...
        const removeLineItem = UseCase.makeRemoveLineItem({
          cartRepository,
          productRepository,
        });

        await expect(() =>
          removeLineItem({ buyerId: "aaa", productId: "aaa" })
  ...
  describe("When buyerId wasn't found", () => {
    it("returns correct cart", async () => {
      ...
      await expect(() =>
        removeLineItem({ buyerId: "bbb", productId: "aaa" })
      ).rejects.toThrow(error);
    });
  });
